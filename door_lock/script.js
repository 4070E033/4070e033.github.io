...
$('#control device').click((e) => {
    <p><input type ="button" onclick="javascript:location.href='https://4070e029.github.io/%E6%99%BA%E6%85%A7%E5%AE%B6%E5%BA%ADFamily.html'" value="設備控制" style="width:150px;height:50px;font-size:20px;background-color:yellow"></input></p>
});
